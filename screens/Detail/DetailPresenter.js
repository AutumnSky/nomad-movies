...
const Container = styled.ScrollView`background-color: ${BG_COLOR};`;

const Header = styled.View`position: relative;`;
...
const Column = styled.View`margin-left: 30px;`;
...
const DataContainer = styled.View`margin-bottom: 10px;`;
      ...
      >
        <Content>
          ...
          <Column>
            ...
            {genres ? (
              <Genres>
                {genres.map((genre, index) => (index === genres.length - 1 ? genre.name : `${genre.name} / `))}
              </Genres>
            ) : null}
          </Column>
        </Content>
